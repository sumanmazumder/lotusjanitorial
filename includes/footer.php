...
<!--Site Footer Start-->
        <footer class="site-footer">
            <div class="site-footer__shape-bg float-bob-y"
                style="background-image: url(images/site-footer-shpae-bg.png);"></div>
                            ...
                            <div class="col-lg-5">
                                <div class="site-footer__top-left">
                                    <div class="site-footer__logo-box">
                                        ...
                                        <p class="site-footer__text-1">We are passionate about delivering exceptional
                                        ...
                                        <div class="row">
                                            <div class="col-xl-4 col-lg-4 col-md-4">
                                                <div class="footer-widget__quick-links">
                                                    ...
                                                    <ul class="footer-widget__quick-links-list list-unstyled">
                                                        <li><a href="index.html"> <span class="icon-next"></span>
                                                                Home</a>
                                                        </li>
                                                        <li><a href="about.html"> <span class="icon-next"></span> About
                                                                Us</a></li>
                                                        <li><a href="contact.html"> <span class="icon-next"></span>
                                                                Contact</a></li>
                                                        <li><a href="faq.html"> <span class="icon-next"></span> FAQs
                                                                Page</a>
                                                        </li>
                                                        <li><a href="blog.html"> <span class="icon-next"></span>
                                                                Our Blogs</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="col-xl-4 col-lg-4 col-md-4">
                                                <div class="footer-widget__essential-links">
                                                    ...
                                                    <ul class="footer-widget__quick-links-list list-unstyled">
                                                        <li><a href="construction-cleaning.php"><span class="icon-next"></span> Construction Cleaning</a></li>
                                                        <li><a href="commercial-cleaning.php"><span class="icon-next"></span> Commercial Cleaning</a></li>
                                                        <li><a href="disaster-restoration-services.php"><span class="icon-next"></span> Disaster and Restoration</a></li>
                                                        <li><a href="floor-maintenance.php"><span class="icon-next"></span> Floor Maintenance</a></li>
                                                        <li><a href="housekeeping-services.php"><span class="icon-next"></span> Housekeeping Services</a></li>
                                                        <li><a href="window-cleaning.php"><span class="icon-next"></span> Window Cleaning</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="col-xl-4 col-lg-4 col-md-4">
                                                <div class="footer-widget__services-links">
                                                    ...
                                                    <ul class="footer-widget__quick-links-list list-unstyled">
                                                        ...
                                                        <li><a href="pressure-wash-services.php"><span class="icon-next"></span> Pressure Wash Services</a></li>
                                                        <li><a href="parking-cleaning-services.php"><span class="icon-next"></span> Parking Cleaning Services</a></li>
                                                        <li><a href="janitorial-services.php"><span class="icon-next"></span> Janitorial Services</a></li>
                                                        <li><a href="data-center-cleaning.php"><span class="icon-next"></span> Data Center Cleaning</a></li>
                                                        <li><a href="retail-cleaning.php"><span class="icon-next"></span> Retail Cleaning</a></li>
                                                        <li><a href="disinfectant-services.php"><span class="icon-next"></span> Disinfectant Services</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <!-- <div class="site-footer__tearms-and-condition">
                                        <ul class="list-unstyled site-footer__tearms-and-condition-list">
                                            <li>
                                                ...
                                                <div class="content">
                                                    <h4><a href="about.html">Here review our terms and <br>
                                            ...
                                            <li>
                                                ...
                                                <div class="content">
                                                    <h4><a href="about.html">We are Chartered certified <br>
                                                            agency. you can trust</a></h4>
                            ...
                            <div class="col-xl-12 col-lg-12">
                                <div class="site-footer__bottom-text-box">
                                    <p class="site-footer__bottom-text text-center">Copyright &copy; 2026 by <a
                                            href="">Lotus Janitorial Services Ltd.</a> All rights reserved.</p>
                                </div>
                            </div>
                        </div>
                    </div>
