...
<main class="page-main">
	...
	<div class="col-sm-6 col-lg-4">
		<div class="service-card">
			...
			<h5 class="service-card-title">Construction Cleaning</h5>
			<ul class="service-card-list">
				<li>Post construction cleanup</li>
				<li>Dust and debris removal</li>
				<li>Floor and glass cleaning</li>
			</ul>
			<a href="construction-cleaning.php" class="service-card-more"><i class="icon-play"></i>Read more</a>
		</div>
	</div>
	...
	<div class="col-sm-6 col-lg-4">
		<div class="service-card">
			...
			<a href="commercial-cleaning.php" class="service-card-more"><i class="icon-play"></i>Read more</a>
		</div>
	</div>
	...
	<div class="col-sm-6 col-lg-4">
		<div class="service-card">
			...
			<h5 class="service-card-title">Disaster and Restoration Services</h5>
			<ul class="service-card-list">
				<li>Water damage cleanup</li>
				<li>Fire damage restoration</li>
				<li>Mold remediation</li>
			</ul>
			<a href="disaster-restoration-services.php" class="service-card-more"><i class="icon-play"></i>Read more</a>
		</div>
	</div>
	...
	<div class="col-sm-6 col-lg-4">
		<div class="service-card">
			...
			<h5 class="service-card-title">Floor Maintenance</h5>
			<ul class="service-card-list">
				<li>Tile and grout cleaning</li>
				<li>Floor polishing services</li>
				<li>Waxing and buffing</li>
			</ul>
			<a href="floor-maintenance.php" class="service-card-more"><i class="icon-play"></i>Read more</a>
		</div>
	</div>
	...
	<div class="col-sm-6 col-lg-4">
		<div class="service-card">
			<div class="service-card-icon"><i class="icon icon-house"></i></div>
			<h5 class="service-card-title">Housekeeping Services</h5>
			<ul class="service-card-list">
				<li>Daily room cleaning</li>
				<li>Bathroom sanitization</li>
				<li>Laundry assistance</li>
			</ul>
			<a href="housekeeping-services.php" class="service-card-more"><i class="icon-play"></i>Read more</a>
		</div>
	</div>
	...
	<div class="col-sm-6 col-lg-4">
		<div class="service-card">
			...
			<ul class="service-card-list">
				...
				<li>Exterior glass washing</li>
				<li>Frame and track cleaning</li>
			</ul>
			<a href="window-cleaning.php" class="service-card-more"><i class="icon-play"></i>Read more</a>
		</div>
	</div>
			...
			<div class="news-carousel row">
				<div class="col-sm-4">
					<div class="news-prw">
						...
						<a href="blog-post-page.html" class="btn-read-more"><i class="icon-play"></i>Read more</a>
					</div>
				</div>
				<div class="col-sm-4">
					<div class="news-prw">
