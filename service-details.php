		...
		<section class="page-header">
            ...
            <div class="container">
                <div class="page-header__inner">
                    ...
                    <h2>Construction Cleanin</h2>
                    <div class="thm-breadcrumb__box">
                        <ul class="thm-breadcrumb list-unstyled">
                            <li><a href="index.html">Home</a></li>
                            <li><span class="icon-arrow-right"></span></li>
                            <li>Construction Cleanin</li>
                        </ul>
                    </div>
                </div>
            </div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-lg-9 aside">
						...
						<h5>How does our Construction Cleaning program work?</h5>
						...
						<div class="contact-box">
							<div class="contact-info-wrap">
								<div class="contact-info">
									<i class="icon icon-technology"></i>Phone: 800-123-4567
									<br> Fax: 718-724-3312
								</div>
								<div class="contact-info">
							...
							<a href="order-form.html" class="btn"><i class="icon icon-bell"></i>Get a Free Estimate</a>
						</div>
					</div>
					<div class="col-md-4 col-lg-3 aside">
						<ul class="services-list">
							<li class="active"><a href="construction-cleaning.php">Construction Cleaning</a></li>
